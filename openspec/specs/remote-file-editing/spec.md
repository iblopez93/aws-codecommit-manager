# remote-file-editing Specification

## Purpose

The remote-file-editing capability closes the biggest usability gap in the README's Known Limitations: remote CodeCommit files open as read-only tabs, forcing users to switch to the AWS console or CLI to fix a typo, and remote content cannot be compared against local workspace files. This capability makes files at a branch tip editable with a guarded save flow and adds in-editor diffing.
