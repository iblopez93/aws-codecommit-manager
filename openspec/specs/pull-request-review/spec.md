...
The pull-request-review capability makes pull request review usable in VS Code. Today the extension lists only general comments in the tree, so reviewers cannot see which files a PR changes, cannot open a diff of those changes, and cannot anchor comments to a file or line. This capability adds changed-file lists, diffs, inline comments, and a details panel.
